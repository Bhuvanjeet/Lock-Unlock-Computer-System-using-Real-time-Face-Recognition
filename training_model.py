...
detector = cv2.CascadeClassifier("D:/Users/Bhuvanjeet/Desktop/haarcascade_frontalface_default.xml")
...
faces,ids = getImagesAndLabels('D:/Users/Bhuvanjeet/Desktop/dataset')  # Get the faces and IDs

recognizer.train(faces, np.array(ids)) # Train the model using the faces and IDs

assure_path_exists('D:/Users/Bhuvanjeet/Desktop/trainer/')    # Save the model into trainer.yml
recognizer.save('D:/Users/Bhuvanjeet/Desktop/trainer/trainer.yml')
