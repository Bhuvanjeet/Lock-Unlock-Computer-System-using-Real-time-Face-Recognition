...
face_cascade = cv2.CascadeClassifier('D:/Users/Bhuvanjeet/Desktop/haarcascade_frontalface_default.xml') # Detect object in video stream using Haarcascade Frontal Face

face_id = 1  # For each person,there will be one face id
count = 0    # Initialize sample face image

check_path("D:/Users/Bhuvanjeet/Desktop/dataset")
...
while(True):
    ...
    for (x,y,w,h) in faces:
        ...
        cv2.imwrite("D:/Users/Bhuvanjeet/Desktop/dataset/User." + str(face_id) + '.' + str(count) + ".jpg", gray[y:y+h,x:x+w]) # Save the captured image into the datasets folder
