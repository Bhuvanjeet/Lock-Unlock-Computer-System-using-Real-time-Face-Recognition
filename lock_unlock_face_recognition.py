...
assure_path_exists("D:/Users/Bhuvanjeet/Desktop/trainer/")

recognizer.read('D:/Users/Bhuvanjeet/Desktop/trainer/trainer.yml')  #load training model

cascadePath = "D:/Users/Bhuvanjeet/Desktop/haarcascade_frontalface_default.xml"  #cascade path
...
while True:
    ...
    for(x,y,w,h) in faces:
        ...
        if(confidence>80):                 #confidence usually comes greater than 80 for strangers
            ...
            Id = "Bhuvanjeet + {0:.2f}%".format(round(100 - confidence, 2)) 
            print("Verified")
            print(confidence)
            counter_correct += 1
        ...
        if(counter_correct == 100):    #if counter = 6 then program will terminate as it has recognized correct user for 6 times. 
            cam.release()
            cv2.destroyAllWindows()
            sys.exit()
